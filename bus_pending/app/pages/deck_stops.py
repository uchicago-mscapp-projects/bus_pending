...
dash.register_page(__name__, 
                   ...
                   title = "Bus stops (Pydeck)", 
                   name =  "Bus stops (Pydeck)")
...
# Convert to html
chi_stops.to_html("example.html")

# Save as deck_compontent to render in dash 
deck_component_stops = dash_deck.DeckGL(
    chi_stops.to_json(), id="deck-gl", tooltip=True, 
