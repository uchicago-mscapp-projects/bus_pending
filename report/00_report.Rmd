...
2.  `analyze_real_data.py` and `analysis.py` Combines the route-level data with expected timing data from the `buses.db` data.
3.  `compare_schedule_real_data.py` then determines delays.
4.  !! Regina to add app structure
